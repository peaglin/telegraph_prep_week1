...
var speak = function(val) "hey hey hey ", val);
};
...
var add5SideEffect = function() {
    sideEffectResults = sideEffectResults + 5
};
...
function superPowerAdder(z) {
    return z.superPower = "JS Ninja-ing";
}
...
var fido = animalMaker("dog", "loud bark", false);
