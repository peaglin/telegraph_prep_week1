...
treasureChest[2] = "pizza";
treasureChest[treasureChest.length] = "gold";
treasureChest.push("flip flops");
...
treasureChest.shift();
treasureChest.unshift("jumper cables");
...
var mysticalAnimal3 = {
    type: "Mermaid",
    collects: ["seashells", "hairbrushes", "forks"],
    canFly: false
};

var mysticalAnimal4 = {
    type: "Chupacabra",
    collects: ["cameras", "children", "rabbits"],
    canFly: false
};

var mysticalAnimal5 = {
    type: "Unicorn",
    collects: ["horn files", "horse brushes", "saddles"],
    canFly: true
};
...
grandCouncil[0] = mysticalAnimal3;

grandCouncil[grandCouncil.length] = mysticalAnimal4;

grandCouncil.push(mysticalAnimal5);
